...
eval_batch_size = 10
train_loader = torch.utils.data.DataLoader(train_, batch_size = args.batch_size, drop = True, num_workers = 0)
test_loader = torch.utils.data.DataLoader(train_, batch_size = eval_batch_size, drop = True, num_workers = 0)
valid_loader = torch.utils.data.DataLoader(train_, batch_size = eval_batch_size, drop = True, num_workers = 0)
